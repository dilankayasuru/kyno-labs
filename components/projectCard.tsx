...
const ImageSlider = dynamic(() => import("@/components/slider"), { ssr: false });import {useState} from "react";
    ...
    return (
        <motion.div
            ...
            <div
                ...
                <p className="text-secondary-text pt-10 text-lg" onClick={toggleExpanded}>
                    {description}
                </p>
            </div>
        </motion.div>
