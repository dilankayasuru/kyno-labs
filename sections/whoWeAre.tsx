    ...
    return (
        <div className="px-6 py-9 text-white">
            ...
            <motion.p
                ...
                over
                10 successful projects, we deliver cutting-edge AI solutions and data-driven insights to drive
                growth
            ...
            <div className="mt-8 grid gap-4 place-content-center">
                ...
                <MetallicCard className="p-4 max-w-xs min-h-40 grid place-content-center">
                    <div className="text-center">
                        ...
                        <div className="grid place-content-center mt-4 max-w-xs">
                            <Image src="/brain.png" alt="map" height={160} width={160} className="h-40 w-auto"
                                   style={{width: "auto", height: "auto"}}/>
                        </div>
                    </div>
                </MetallicCard>
                <MetallicCard className="p-4 max-w-xs min-h-40 grid place-content-center">
                    <div className="text-center">
                        <div className="grid place-content-center">
                            <Image src="/placeholder-company1.png" alt="compnay 1 logo" height={160} width={160}
                                   className="h-40 w-auto" style={{width: "auto", height: "auto"}}/>
                        </div>
                ...
                <MetallicCard className="p-4 max-w-xs min-h-40 grid place-content-center">
                    <div className="text-center">
                        <div className="grid place-content-center">
                            <Image src="/placeholder-company2.png" alt="compnay 2 logo" height={160} width={160}
                                   className="h-40 w-auto" style={{width: "auto", height: "auto"}}/>
                        </div>
